...
//
//     [Header("Estabilidad del c�lculo")]
...
//     [Tooltip("Opcional: marco expl�cito. Si es null usa transform.parent (o este transform si no hay padre).")]
...
//     {
//         // El valor del LayerMask es un bitmask, necesitamos el �ndice (el n�mero de bit activo)
//         int newLayer = Mathf.RoundToInt(Mathf.Log(layerMask.value, 2));
//
//         if (newLayer < 0 || newLayer > 31)
//         {
//             Debug.LogError("LayerMask inv�lido. Asegurate de pasar solo una layer, no m�ltiples.");
//             return;
//         }
//
