...
public class PlayerPlatformHandler : MonoBehaviour
{
    ...
    [Tooltip("Distancia máxima del rayo hacia abajo.")]
    [Min(0f)]
    ...
    void FixedUpdate()
    {
        // Si el jugador está en el suelo (useGravity = false)
        // y está sobre una plataforma, lo movemos con ella
        ...
        if (rayOrigin == null)
        {
            Debug.LogWarning($"{name}: No se asignó el origen del rayo. Asigna un Transform en 'rayOrigin'.");
            return;
        }
