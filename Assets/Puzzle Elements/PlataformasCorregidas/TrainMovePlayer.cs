...
namespace Puzzle_Elements.PlataformasCorregidas
{
    public class TrainMovePlayer : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            // Actualizamos posici�n anterior del tren
            _lastTrainPosition = currentTrainPos;
        }

        /// <summary>
        /// Lanza un rayo en direcci�n de movimiento del player.
        ...
        private void HandleFrontBlock()
        {
            ...
            if (speed <= 0.01f) return; // no se est� moviendo, no hace falta ray
            ...
            // Raycast hacia la direcci�n de movimiento
            if (Physics.Raycast(origin, dir, out RaycastHit hit, rayDistance, rayMask, QueryTriggerInteraction.Ignore))
            {
                ...
                {
                    // Proyecci�n de la velocidad del player sobre la direcci�n de avance
