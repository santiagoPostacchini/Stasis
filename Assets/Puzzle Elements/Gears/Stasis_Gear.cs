...
namespace Puzzle_Elements.Gears
{
    public class StasisGear : MonoBehaviour, IStasis
    {
        ...
        public readonly string OutlineThicknessName = "_BorderThickness";
        private MaterialPropertyBlock _mpb;
        [FormerlySerializedAs("_renders")] [SerializeField] private List<Renderer> renders = new List<Renderer>();
        ...
        public StasisGear(StasisEffect stasisEffect)
        {
            StasisEffect = stasisEffect;
        }
        ...
        private void Start()
        {
            ...
            if (controlEmission && forceEnableEmissionKeyword && renders != null)
            {
