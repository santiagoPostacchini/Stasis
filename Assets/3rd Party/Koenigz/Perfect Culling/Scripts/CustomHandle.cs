...
public static class CustomHandle
{
                                    ...
                                    where U : struct
    {
        ...
        void DrawHandleForDirection(T origin, Matrix4x4 matrix4X4, Vector3 axis)
        {
            ...
            var fmh_56_73_638616470621094403 = Quaternion.identity; Vector3 hPos3 = UnityEditor.Handles.FreeMoveHandle(basePos, size, snap, UnityEditor.Handles.DotHandleCap);
