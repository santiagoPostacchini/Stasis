...
public class ErraticObject : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Debug.LogError("Necesit�s al menos 2 puntos para el movimiento err�tico.");
            enabled = false;
            return;
        }
